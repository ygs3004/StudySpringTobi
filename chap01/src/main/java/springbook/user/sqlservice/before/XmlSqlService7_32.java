...
public class XmlSqlService7_32 implements SqlService {
    ...
    public void loadSql(){
        ...
        try {
            ...
            InputStream is = UserDao.class.getResourceAsStream(this.sqlmapFile); // UserDao 와 같은 클래스패스의 sqlmap.xml 파일 변환
