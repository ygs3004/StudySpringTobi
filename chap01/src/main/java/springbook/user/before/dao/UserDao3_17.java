...
public class UserDao3_17 {

    private ConnectionMaker connectionMaker;
    private DataSource dataSource;
    private static UserDao3_17 INSTANCE;
    ...
    public UserDao3_17(ConnectionMaker connectionMaker) {
        this.connectionMaker = connectionMaker;
    }

    public static synchronized UserDao3_17 getInstance() {
        if (INSTANCE == null) INSTANCE = new UserDao3_17();
        return INSTANCE;
    }
